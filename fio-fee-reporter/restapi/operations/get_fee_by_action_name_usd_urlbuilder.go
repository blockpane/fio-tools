...
func (o *GetFeeByActionNameUsdURL) Build() (*url.URL, error) {
	...
	var _path = "/fee/byActionName/usd"
...
func (o *GetFeeByActionNameUsdURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on GetFeeByActionNameUsdURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on GetFeeByActionNameUsdURL")
	}
